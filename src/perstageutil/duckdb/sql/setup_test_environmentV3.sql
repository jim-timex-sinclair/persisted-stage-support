...
__pstage_load_timestamp TIMESTAMP);
...
create_timestamp TIMESTAMP,
update_timestamp TIMESTAMP,
__pstage_load_timestamp TIMESTAMP not null,
...
PRIMARY KEY(loan_number, __pstage_load_timestamp));
...
(loan_number, loan_amount, loan_officer, create_timestamp, update_timestamp, __pstage_load_timestamp)
